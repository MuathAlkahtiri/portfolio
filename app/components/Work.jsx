    ...
    return (
        <motion.div
            ...
            <motion.p
                ...
                my skills and growth in frontend development.
            </motion.p>
            <motion.div
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
                ...
                {workData.map((project, index) => (
                    <motion.div
                        ...
                        <a href={project.link} target='_blank' rel='noreferrer' className='w-full h-full block'>
                            <div className='bg-white w-10/12 rounded-md absolute 
                    bottom-5 left-1/2 -translate-x-1/2 py-3 px-5 flex items-center 
                    justify-between duration-500 group-hover:bottom-7 dark:bg-darkHover dark:text-white'>
                                <div>
                                    <h2 className='font-semibold'>{project.title}</h2>
                                    <p className='text-sm text-gray-700 dark:text-gray-200'>{project.description}</p>
                                </div>

                                <div className='border rounded-b-full border-black w-9 aspect-square
                        flex items-center justify-center shadow-[2px_2px_0_#000] group-hover:bg-lime-300 transition dark:border-white dark:shadow-[2px_2px_0_#fff]'>
